...
class OrdenLaboreoFiltrosConPage extends GetView<OrdenLaboreoFiltrosConController> {

  OrdenLaboreoFiltrosConPage({Key? key}) : super(key: key);
...
class BtnAplicarFiltro extends StatelessWidget {
  ...
  final OrdenLaboreoFiltrosConController controller;
