...
class OrdenLaboreContratistaDetallePage extends GetView<OrdenLaboreoContratistaDetalleController> {
  
  OrdenLaboreContratistaDetallePage({Key? key}) : super(key: key);

  OLFullContratista? olFullContratista;
              ...
              children: [
                ...
                SingleChildScrollView(
                  child: Padding(
                    ...
                    child: _datosPrincipales(state!, controller.param.gEconomicoId, controller.param.empresaId),
                  ),
                ),
                //!------------------------------------------- tab 2
                SingleChildScrollView(
...
Widget _getPrecios(OLFullContratista ordenLaboreo) {
...
// * -------------------------------------------------------------------------------------------------- solapa 1
Widget _datosPrincipales(ObtenerOrdenDeLaboreoContratistaDetalleResponse r, String gEconomicoId, String empresaId) {
...
// * -------------------------------------------------------------------------------------------------- solapa 2
Widget _totalInsumos(ObtenerOrdenDeLaboreoContratistaDetalleResponse r) {
...
// * -------------------------------------------------------------------------------------------------- solapa 3
Widget _totalInsumosPorLotes(ObtenerOrdenDeLaboreoContratistaDetalleResponse r) {
                ...
                children: [
                  Container(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        OLDetalleLoteInsumoItem dataItem = e.listaDetalleLoteInsumos[index];
                        registro++;
