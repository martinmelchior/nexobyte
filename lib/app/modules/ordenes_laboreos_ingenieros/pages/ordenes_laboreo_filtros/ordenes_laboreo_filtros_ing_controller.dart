...
class OrdenesLaboreoFiltrosIngController extends GetxController {

  OrdenesLaboreoFiltrosIngController();
  ...
  final filtrosOLs = Get.arguments["filtrosOLs"] as Rx<FiltrosOLsIng>;

  // * ----------------------------------------------------------------------------- en onInit ya recibo los parametros !
  final itemResumenIngeniero = Get.arguments["itemResumenIngeniero"] as OrdenesLaboreosResumenDeIngenieroItem;
  ...
  bool pageIsValid() {
    ...
    if (filtrosOLs.value.verSoloMisOLs) returnValue =true;
    ...
    if (filtrosOLs.value.contratista != null && filtrosOLs.value.contratista!.clienteId! > 0) returnValue = true;
    return returnValue;
  }
