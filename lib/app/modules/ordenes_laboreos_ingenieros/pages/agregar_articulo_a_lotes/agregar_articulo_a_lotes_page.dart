...
class AgregarArticuloALotesPage
    extends GetView<AgregarArticuloALotesController> {
  AgregarArticuloALotesPage({Key? key}) : super(key: key);
    ...
    return Form(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
                "Dosis a aplicar en\ntodos los lotes (${controller.hasTotalesShow} has)",
      ...
      child: TextFormField(
        ...
        onChanged: (value) {
          try {
            ...
            double _hasTotales = 0.0;
            for (Lote lote in controller.paso1Controller.rxOLAbm.value.lotes) {
              if (lote.seleccionado!) {
                _hasTotales += lote.cantHasTrabajadas!;
              }
            }
            controller.txtTotalController.value.text =
                (_dosis * _hasTotales).toStringAsFixed(4);
          } catch (e) {
    ...
    return Focus(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          enabledBorder: _enabledBorder,
          focusedBorder: _focusedBorder,
          labelText: 'TOTAL a utilizar en ${controller.hasTotalesShow} has',
          labelStyle: _labelStyle,
          suffixText: r"  " + um,
          hintStyle: const TextStyle(
            color: Colors.grey,
        ...
        onChanged: (value) {
          try {
            ...
            controller.txtDosisController.value.text =
                (_total / _hasTotales).toStringAsFixed(4);
          } catch (e) {
            controller.txtDosisController.value.text = "0";
            controller.txtTotalController.value.text = "0";
          }
