...
class FacturasReservaClientesPage extends GetView<FacturasReservaClientesController> {

  FacturasReservaClientesPage({Key? key}) : super(key: key);
    ...
    return Form(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: const Text("Seleccione una Cuenta", style: TextStyle(fontSize: 17.0, color: kTAllLabelsColor)),
            centerTitle: true,
          ),
          body: Stack(
            children: [
...
class ShowCtaCteResumenItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Get.toNamed(AppRoutes.rFacturaReservaReporte, arguments: { "itemResumenCtaCte": itemResumenCtaCte }),
      child: Card(
