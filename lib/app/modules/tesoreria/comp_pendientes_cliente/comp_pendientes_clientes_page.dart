...
class CompPendientesClientesPage extends GetView<CompPendientesClientesController> {

  CompPendientesClientesPage({Key? key}) : super(key: key);
...
class ShowCtaCteResumenItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Get.toNamed(AppRoutes.rCompPendReporte, arguments: { "itemResumenCtaCte": itemResumenCtaCte }),
      child: Card(
