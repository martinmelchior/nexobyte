...
class CompPendientesClientesController extends GetxController with StateMixin<CtaCteResumenDeSaldosResponse> {

  final CompPendientesClientesProvider provider = Get.find<CompPendientesClientesProvider>();
