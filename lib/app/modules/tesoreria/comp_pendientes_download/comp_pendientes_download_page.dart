...
class CompPendientesDownloadPage extends GetView<CompPendientesDownloadController> {

  const CompPendientesDownloadPage({Key? key}) : super(key: key);
...
class ShowComprobantes extends StatelessWidget {
  ...
  final CompPendientesDownloadController controller = Get.find<CompPendientesDownloadController>();
