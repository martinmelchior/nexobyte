...
class CompPendientesDownloadProvider extends GetConnect {

  final d.Dio _dio = Get.find<d.Dio>();

  Future<FileDataXlsPdfResponse> generarListadoComprobantesPendientesXlsPdf(CtaCteResumenDeSaldosItem itemResumenCtaCte) async {
   
    //-- Envio el token
    _dio.options.headers = { HttpHeaders.authorizationHeader: "Bearer " + PreferenciasDeUsuarioStorage.tokenDeAcceso };
    
    final d.Response r = await _dio.post("/usuarios/GenerarListadoComprobantesPendientesXlsPdf", 
                                            data: {
